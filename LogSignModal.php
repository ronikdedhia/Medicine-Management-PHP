      ...
      <div class="modal-header">
        <div class="modal-body">
          <ul class="nav nav-pills">
            <li class="active"><a class="check_out" href="#home" data-toggle="tab">Login</a>
            </li>
              <li><a class="check_out" href="#profile" data-toggle="tab">Sign Up</a>
              </li>
          </ul>
...
<div class="panel-footer">
    <p align="center">Online Medicine Delivery System</a></p>
        </div>
    </div> 
</div>
...
<div class="panel-body">
  <input class="proid" type="hidden" name="proid" id="proid" value="">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
          <div class="col-md-10">
            <label class="col-md-4 control-label" for=
            "HOMEADDRESS">Home Address:</label>

            <div class="col-md-8">
               <textarea class="form-control input-sm" id="HOMEADDRESS" name="HOMEADDRESS" placeholder=
                  "Complete Home Address" type="text" value=""></textarea> 
            </div>
          </div>
        </div>
      ...
      <div class="form-group">
          <div class="col-md-10">
            <label class="col-md-4 control-label" for=
            "DELADDRESS">Delivery Address:</label>

            <div class="col-md-8">
               <textarea class="form-control input-sm" id="DELADDRESS" name="DELADDRESS" placeholder=
                  "Delivery Address" type="text" value=""></textarea> 
            </div>
          </div>
        </div>
      ...
      <div class="col-md-10">
        ...
        <div class="col-md-8">
           <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder=
              "+63 0000000000" type="text"  maxlength="13" value="">
        </div>
      </div>
    </div>
     <div class="form-group">
      ...
      <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
         <small>Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of Online Medicine Delivery Incorporated.</small>
    ...
    <div class="form-group">
      <div class="col-md-10">
        ...
        "image"></label>
        <div class="col-md-8">
          <input type="submit"  name="submit"  value="Sign Up"  class="submit btn btn-success"  />
  ...
  <div class="panel-footer">
      <p align="center">Online Medicine Delivery System</p>
  </div> 
</div> 
<!-- end panel sign up -->
</form>  
