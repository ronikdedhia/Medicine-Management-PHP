        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>rider/index.php" >Medicine Delivery</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right"> 
                 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                            ...
                            <?php if ($_SESSION['EMAIL']=='Administrator') {
                            # code...
                        ?>
                         <li><a href="<?php echo web_root; ?>rider/employee/index.php?view=add"><i class="fa fa-user  fa-fw"></i> Employee</a>
                            </li>
                        <?php }?>
...
$singleemployee = $employee->single_employee($_SESSION['EMPID']);

?> 
                <!-- /.dropdown -->
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Howdy, <?php echo $_SESSION['EMAIL']; ?> <img title="" width="23px" height="17px" src="<?php echo web_root.'rider/employee/'.$singleemployee ->IMAGES ?>">  
                    ...
                    <ul class="dropdown-menu dropdown-acnt">
                          ...
                          <div class="divpic"> 
                            <a href="" data-target="#usermodal"  data-toggle="modal" > 
                                <img title="profile image" width="70" height="80" src="<?php echo web_root.'rider/employee/'.$singleemployee ->IMAGES ?>">  
                            </a>
                          </div> 
                    

                      <div class="divtxt">
                        <li><a href="<?php echo web_root; ?>rider/employee/index.php?view=edit&id=<?php echo $_SESSION['EMPID']; ?>"> <?php echo $_SESSION['EMAIL']; ?> </a>
                      <li><a title="Edit" href="<?php echo web_root; ?>rider/employee/index.php?view=edit&id=<?php echo $_SESSION['EMPID']; ?>"  >Edit My Profile</a>
                                    
                        </li>
                          </li>
                           <li><a href="<?php echo web_root; ?>rider/logout.php"><i class="fa fa-sign-out fa-fw"></i> Log Out</a>
                        </li> 
                  </div>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo web_root; ?>rider/orders/index.php"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>rider/orders/index.php" ><i class="fa fa-reorder fa-fw"></i>  Orders <?php echo $order; ?></a>
                  </li>
  ...
  format: 'mm/dd/yyyy',
    ...
    forceParse: 0,
     changeMonth: true,
      ...
      <footer><p  style="text-align: center;font-weight: bold;">Copyright &copy; Online Medicine Delivery System 2020 </p></footer>
</html>