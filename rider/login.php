...
require_once("../include/initialize.php");
 ...
 // login confirmation
  if(isset($_SESSION['EMPID'])){
    redirect(web_root."rider/index.php");
  }
  ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<title>Login | OMDS</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				<form method="post" action=""  class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Email is required">
						<input class="input100" type="Email"  name="emp_email"  placeholder="Email Address">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Password is required">
						<input class="input100" type="password" name="emp_pass" placeholder="Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
...
if(isset($_POST['btnLogin'])){
  ...
  //it creates a new objects of member
    ...
    if ($res==true) { 
       message("You logon as ".$_SESSION['EMAIL'].".","success");
