        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default panel-shadow">
                    <div class="panel-heading panel-medicine" > 
                        <h1> Cart List </h1>     
                    </div>
                    ...
                    <div class="table-responsive">
                         ...
                         <body onload=" totalprice(); ">
                            <tr> 
                             <td>
                               <div  class="medicine_scroll_cart" >
                             <?php
                              ...
                              if (!empty($_SESSION['medicine_cart'])){ 
                                ...
                                for ($i=0; $i < $count_cart  ; $i++) { 
                                     ...
                                     echo 'for id :'. $_SESSION['cart'][$i]['productid'] ;
                                      ...
                                      WHERE o.`CATEGORYID`=p.`CATEGORYID` and `PRODUCTID` = '".$_SESSION['medicine_cart'][$i]['productid']."'";
                                       $mydb->setQuery($query);
                              ...
                              <form id="form" action="cart/controller.php?action=edit" method="POST"  
                                  ...
                                  <div class="column4">                                  
                                    ...
                                    <div class="form-inline" style="float: left; width:190px">  
                                        <input class="form-control" autocomplete="off"  id ="QTY" name="QTY<?php echo $result->PRODUCTID ?>" type="number"  value="<?php echo $_SESSION['medicine_cart'][$i]['qty']; ?>"> 
                                        <!-- hidden -->
                                        <input type="hidden" id="PRICE" name="PRICE" value="<?php echo $result->PRICE; ?>" />
                                        <input type="hidden" id="TOT" name="TOT<?php echo $result->PRODUCTID ?>" value="<?php echo $_SESSION['medicine_cart'][$i]['price']; ?>" />
                ...
                <a href="index.php?page=7" name="proceed"  class="btn btn_medicine pull-right"   ><strong>Proceed And Checkout</strong> <span class="glyphicon glyphicon-chevron-right"></span></a> 
