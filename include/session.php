...
function product_exists($pid){
 ...
 function addtocart($pid,$q,$qqty,$price,$bgo,$CATEGID){
    ...
    if(is_array($_SESSION['gcCart'])){
      ...
      $_SESSION['gcCart'][$max]['qqty']=$qqty;
      $_SESSION['gcCart'][$max]['bgo']=$bgo;
      $_SESSION['gcCart'][$max]['CATEGID']=$CATEGID;
    }
    else{
     $_SESSION['gcCart']=array();
      ...
      $_SESSION['gcCart'][0]['qqty']=$qqty;
      $_SESSION['gcCart'][0]['bgo']=$bgo;
      $_SESSION['gcCart'][0]['CATEGID']=$CATEGID;
    }
}else{
     $_SESSION['gcCart']=array();
      $_SESSION['gcCart'][0]['productid']=$pid;
