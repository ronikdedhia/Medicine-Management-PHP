  ...
  <div class="modal-content">
	<div class="modal-header">
		...
		<table>
			<tr>
				<td align="center"> 
				<img src="<?php echo web_root; ?>images/home/company-logo.png"   alt="Image">
        		</td> 
			</tr>
		</table>
 	 ...
 	 <h4>Your order has been confirmed and delivered</h4><br/>
		...
		<h5>Your order is on its way! As you have ordered via Cash on Delivery, please have the exact amount of cash for our deliverer.	</h5>
		 ...
		 <div class="row">
		 	...
		 	<div class="col-md-6">
		 	<p>Name : <?php echo $cur->FNAME . ' '.  $cur->LNAME ;?></p>
		 	<p>Address : <?php echo $cur->DELADDRESS;?></p>
		 		<p>Contact Number : <?php echo $cur->PHONE;?></p>
		 	</div>
		 </div>
<?php 
}
...
<hr/>
 <h4><strong>Order Information</strong></h4>
				 ...
				 $subtot=0;
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		?>
				  		 <td> &#8369 <output><?php echo  number_format(($result->PROPRICE*$result->ORDEREDQTY),2); ?></output></td>  
				  		<?php
				  		...
				  		$subtot +=$result->PROPRICE*$result->ORDEREDQTY;
		...
		?>
 		...
 		<div class="row">
		  ...
		  <div class="row">
		  	  ...
		  	  <p>Sincerely.</p>
		  	  <h4><a href="https://bit.ly/2LPn9Wu">Medicine Delivery Incorporation</a></h4>
		  </div>
		  <?php }?>
  </div> 
		...
		<?php if($cur->ORDEREDSTATS!='Pending' || $cur->ORDEREDSTATS!='Cancelled' ){ ?> 
                ...
                <button  onclick="tablePrint();" class="btn btn_medicine pull-right "><span class="glyphicon glyphicon-print" ></span> Print</button>     
