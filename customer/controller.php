...
function doInsert(){
	...
	if(isset($_POST['submit'])){
						...
						$customer->HOMEADDRESS  	= $_POST['HOMEADDRESS']; 
						$customer->DELADDRESS  		= $_POST['DELADDRESS']; 
...
if(!isset($_FILES['image']['name'])){
	$location = '';
			...
			$summary->HVIEW 			= 0	;
			unset($_SESSION['gcCart'][$i]['qty']);
			unset($_SESSION['gcCart'][$i]['price']);
			unset($_SESSION['gcCart'][$i]['qqty']);
			$summary->create();
		  }
